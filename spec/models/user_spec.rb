...
describe User do
  ...
  it "should reject duplicate email addresses" do
    # Put a user with a given email into the database
    User.create!(@attr)
  ...
  describe "password validations" do
    ...
    it "should require a matching password confirmation" do
      diff_password_confirmation = User.new(@attr.merge(:password_confirmation => "invalid"))
      diff_password_confirmation.should_not be_valid
    end
  ...
  describe "relationships" do
    ...
    it "should include the follower in the following array" do
      @user.follow!(@followed)
      @user.followers.should include(@user)
    end
  end
end
